...
if [[ "$SOURCE_VENDOR_API_LEVEL" != "$TARGET_VENDOR_API_LEVEL" ]]; then
    ...
    if [ "$SOURCE_VENDOR_API_LEVEL" -gt "35" ] && [ "$TARGET_VENDOR_API_LEVEL" -gt "35" ]; then
        :
    elif [ "$SOURCE_VENDOR_API_LEVEL" -gt "35" ] && [ "$TARGET_VENDOR_API_LEVEL" -le "35" ]; then
        ADD_TARGET_VNDK_APEX
    ...
    elif [ "$SOURCE_VENDOR_API_LEVEL" -le "35" ] && [ "$TARGET_VENDOR_API_LEVEL" -gt "35" ]; then
